...
import Img2 from "../AtataServicesPage/ServicesImage/AtataPay.png"
import img1 from "../AtataServicesPage/Logistics/img/headerbg.jpg"


function AtatalogisticsPage ( ) {
      return (
      <MyCar>
        <div>
  <nav className="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div className="container">
      <a className="navbar-brand js-scroll-trigger" href="#page-top">
        <img src={{Img2}} style={{width:'80px', height:'80px'}} alt />
      </a>
      <button
  ...
  <header className="masthead">
    <div className="container">
      <div className="masthead-subheading"> We deliver to you Doorstep</div>
  ...
  <section className="page-section" id="services">
    <div className="container">
      <div className="text-center">
        <h2 className="section-heading text-uppercase">Benefits of Atata Logitics</h2>
        <h3 className="section-subheading text-muted">
       Instead of worrying about the nitty-gritty details of delivering your inventory 
        to your consumers<p></p>we have various logistics and cargo services from all over the 
        continent right here on our platform and have made them very accessible to you.<p></p>
         Delivery options are available for you right after purchase. This saves you time 
         and money in the long run. <p></p>
 Once you select the AtataLogistics option, we automatically
 offer you multiple delivery services with their costs allotted to them and you have
  the option of selecting whichever fits your pocket size. We appeal to your preference
   and choice.<p></p>
These services operate whether by air, land, or by water, in order to get the job
 done. 


All of these affiliates work hand in hand to give you the full <p></p> African shopping experience on Atata57.com. They have been carefully designed to serve the needs of buyers and sellers and are great service options for all. 
  ...
  <section className="page-section bg-light" id="portfolio">
    <div className="container">
      <div className="text-center">
        <h2 className="section-heading text-uppercase">Amazing Deals</h2>
        <h3 className="section-subheading text-muted">
...
`;
export default AtatalogisticsPage;